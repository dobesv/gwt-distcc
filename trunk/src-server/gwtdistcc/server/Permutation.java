...
public class Permutation implements Comparable<Permutation> {
	...
	public String toString() {
		...
		(buildError != null ? " failed at "+buildErrorTime+": '"+buildError+"'":"")+
	...
	public Date getFreshness() {
		...
		if(buildErrorTime != null && buildErrorTime.after(result)) result = buildErrorTime;
		return result;
	}
	...
	public Date getBuildErrorTime() {
		return buildErrorTime;
	}

	public void setBuildErrorTime(Date buildErrorTime) {
		this.buildErrorTime = buildErrorTime;
	}
